...
static get_coord_function 	coord_getters[N_TABLES] 	= {corner_orientation_coordinate_1,	edge_orientation_coordinate_1, 	corner_permutation_coordinate_2,		UD_slice_coordinate_1, 	edge_permutation_coordinate_2, 		UD_slice_sorted_coordinate_2};
static set_coord_function 	coord_setters[N_TABLES] 	= {set_corner_orientation_coord_1,	set_edge_orientation_coord_1, 	set_corner_permutation_coordinate_2, 	set_UD_slice_coord_1, 	set_edge_permutation_coordinate_2, 	set_UD_slice_sorted_coordinate_2};
...
static int					coord_range[N_TABLES] 		= {N_CORNER_ORI_1,					N_EDGE_ORI_1, 					N_CORNER_PERMUTATION_2,				N_UD_1, 					N_EDGE_PERMUTATION_2, 				N_UD_2};
